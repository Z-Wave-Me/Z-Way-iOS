...
@interface ZWPickerPopup : UIControl <UIKeyInput, UIPopoverControllerDelegate>
{
	UIPopoverController *_popoverController; // for iPad
    UIView *_backgroundTint; // for iPhone
